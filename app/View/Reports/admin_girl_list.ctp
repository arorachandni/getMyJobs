	...
	<?php if (! empty($users)){?>
		<div class="transFilt">
	        <div class="transFilt-R">
				<?php echo $this->Html->link('Export CSV',array('controller'=>'reports', 'action' => 'exportUser/2'),array('class' => 'submitBtn'));?>
			</div>
		</div>
	<?php } ?>
    <div class="clr">&nbsp;</div>
		...
		<div class="appoiTable2">
			<table width="100%" border="0" cellspacing="0" cellpadding="0">
				  <tr>
					...
					<th width="20%"><?php echo $this->Paginator->sort("name",__("First Name")); ?></th>
				  ...
				  <tr class="<?php echo $tableClass;?>">
					...
					<td><?php echo $userData['User']['first_name']; ?></td>
