            ...
            if ($continue == 'true') {
                ...
                if (!file_exists($cachedImagePath)) {//save image with new dimension start
                    ...
                    if ($imgType == 'image/gif') {
                        $image_source = imagecreatefromgif($originalFilePath);
                        $img_type = 'gif';
                    }
                    ...
                    if ($img_type != 'png') {
                        ...
                        switch ($imgInfo[2]) {
                            case 1: $image_source = imagecreatefromgif($originalFilePath);
                                break;
                            case 3: $image_source = imagecreatefrompng($originalFilePath);
                                break;
                        }
                        ...
                        switch ($imgInfo[2]) {
                            case 1: imagegif($new_image, $remote_file);
                                break;
                            case 3: imagepng($new_image, $remote_file);
                                break;
                        }
                    }
